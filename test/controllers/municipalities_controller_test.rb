...
class MunicipalitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create municipality" do
    assert_difference('Municipality.count') do
      post municipalities_url, params: { municipality: { name: @municipality.name, state: @municipality.state } }
    end
  ...
  test "should update municipality" do
    patch municipality_url(@municipality), params: { municipality: { name: @municipality.name, state: @municipality.state } }
